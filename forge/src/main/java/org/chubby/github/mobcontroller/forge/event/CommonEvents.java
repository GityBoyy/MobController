package org.chubby.github.mobcontroller.forge.event;
...
public class CommonEvents {
    ...
    @SubscribeEvent
    public static void mobTickEvent(LivingEvent.LivingTickEvent event) {
...
//        if (event. == VanillaGuiOverlay.DEBUG_TEXT && MCConfig.enableDebug.getValue()) {
