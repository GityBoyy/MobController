...
public class RecipeRegistry
{
    ...
    public static final RegistrySupplier<RecipeType<NeuralInterfaceStationRecipe>> NEURAL_INTERFACE_STATION_TYPE =
            RECIPE_TYPES.register(Utils.resource("neural_interface_station_type"),
                    ()-> new RecipeType<NeuralInterfaceStationRecipe>() {
                        @Override
                        public String toString() {
                            return Constants.MOD_ID + "_neural_interface_station_type";
                        }
                    });

    public static final RegistrySupplier<RecipeSerializer<NeuralInterfaceStationRecipe>> NEURAL_INTERFACE_STATION_SERIALIZER =
            RECIPE_SERIALIZERS.register(Utils.resource("neural_interface_station_serializer"),
