...
public class ModJeiPlugin implements IModPlugin {
    ...
    public ResourceLocation getPluginUid() {
        return ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, "plugin");
    }

    @Override
    public void registerCategories(IRecipeCategoryRegistration registration) {
        IGuiHelper helper = registration.getJeiHelpers().getGuiHelper();
        registration.addRecipeCategories(new NeuralInterfaceRecipeCategory(helper));
    }
    ...
    public void registerRecipes(IRecipeRegistration registration) {
        registration.addRecipes(
                ...
                this.getRecipes(RecipeRegistry.NEURAL_ASSEMBLER_TYPE.get())
        );
    }
    ...
    public void registerGuiHandlers(IGuiHandlerRegistration registration) {
        registration.addRecipeClickArea(
                NeuralInterfaceStationScreen.class,
                70, 30, 25, 20,
                NeuralInterfaceRecipeCategory.NEURAL_STATION_RECIPE_RECIPE_TYPE
        );
    }
